...
export const FORM_INPUT = "bg-secondary-300/10 w-full rounded-md my-2 py-4 px-6 text-blue-500 font-medium rounded-lg text-center text-md hover:cursor-pointer focus:outline-none hover:bg-secondary-200/30 duration-100";
