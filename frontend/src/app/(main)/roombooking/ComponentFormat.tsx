...
export const FORM_INPUT = `bg-secondary-300/10 w-full rounded-md xl:my-2 xl:py-4 text-blue-500 font-medium rounded-lg text-center xl:text-base hover:cursor-pointer focus:outline-none hover:bg-secondary-200/30 duration-100
...
export const FormHeader = ({ id, title, imgPath, imgAlt }:FormHeaderProps) => {
    ...
    <div className="flex items-center">
        <span className="text-zinc-800 font-medium xl:text-xl px-2 items-center md:text-lg">
          {id}
        </span>
        <span className="text-zinc-700 font-medium xl:text-lg items-center flex pr-2 md:text-lg">
          {title}
        </span>
        <Image
          src={imgPath}
