...
const FloorPlan: React.FC<FloorPlanProps> = ({ setRoomID, dataFromApi }) => {
          ...
          <div className="w-67/100 flex flex-col">
            <div className="h-41/100 flex flex-row">
              ...
              <div className="w-4/5 flex flex-col">
                <div className="h-2/5 text-[10px] bg-slate-400 rounded-md border-2 flex justify-center items-center">
                  Utility
                </div>
                <div className="h-3/5 flex flex-row">
                  <div className="w-58/100 flex flex-col">
                    <div className="h-77/100 bg-slate-400 rounded-md flex justify-center items-center">
                      <Image
                        src={toilet}
                        alt="Toilet Icon"
                        className={`${iconStyle} p-1 `}
                  ...
                  <div className="w-42/100 bg-slate-400 rounded-md flex justify-center items-center">
                    <Image
                      src={toilet}
                      alt="Toilet Icon"
                      className={`${iconStyle} p-1 `}
        ...
        <div className="w-44/100 flex flex-col">
          <div className="h-75/100 flex flex-row">
            ...
            <div className="w-17/100 flex flex-col">
              ...
              <div className="h-10/100 bg-slate-400 rounded-md flex justify-center items-center">
                <Image
                  src={stairs}
                  alt="Stair Icon"
              ...
              <div className="h-68/100 bg-slate-400 rounded-md flex flex-col justify-center items-center space-y-1">
                <span>
                  <Image
                    src={lift}
                    alt="LiftIcon"
  ...
  const SecondLeftWing = () => {
    return (
      <div className={`${floorplanStyle}`}>
        <div className="h-10/100 bg-slate-400 rounded-md"></div>
        ...
        <div className="h-80/100 flex flex-col">
          ...
          <div className="h-40/100 w-98/100 flex flex-row">
            ...
            <div className="w-15/100 flex flex-col">
          ...
          {/* Middle Corridor */}
          <div className="h-10/100 w-full"></div>

          {/* Bottom Area */}
          <div className="h-50/100 flex flex-row">
            <div className="flex flex-col">
              <div className="h-2/3 flex flex-row">
                <div className="flex flex-col">
                  <div className="h-20/100"></div>
                  <div className="h-30/100 bg-slate-400 rounded-t-md flex items-center justify-center">
              ...
              <div className="h-1/3 bg-slate-400 rounded-tr-sm flex items-center justify-center">
            ...
            <div className="w-10/100 flex transform -rotate-90 justify-center items-center text-2xl">
              Lobby
            </div>
          </div>
        </div>

        <div className="h-10/100 rounded-bl-md bg-slate-400"></div>
      </div>
    );
  };
  ...
  const ThirdLeftWing = () => {
    return (
      <div className={`${floorplanStyle} p-2`}>
