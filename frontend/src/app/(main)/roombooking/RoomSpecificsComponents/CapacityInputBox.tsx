...
const CapacityInput:React.FC<CapacityInputProps> = ({setCapacity}) => {
  ...
  return (
    <div className="">
      <label className="font-medium text-black-600 xl:text-base md:text-sm">Capacity: </label>
      <input
        type="text"
        className="rounded-md text-center bg-blue-50 text-blue-500 w-24 h-12 mx-2 placeholder-blue-400 
        focus:placeholder-opacity-0 focus:outline-none xl:text-base md:text-sm"
