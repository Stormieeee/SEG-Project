...
const RectangularCheckbox: React.FC<RectangularCheckboxProps> = ( { label, checked, onChange }) => {
  ...
  return (
    <div className="flex items-center relative rounded-[5px] border my-2 ml-2 mr-20 py-5 px-5 border-gray-300 text-black-500 text-base font-medium bg-white-50 md:px-3 md:text-sm md:py-4">
      <label>{label}</label>
      <div
