...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 flex flex-col  h-screen bg-white-50 border-zinc-200 md:flex">
        ...
        >
          ...
          <span
            className={`text-xl pt-2 flex md:flex ${
              isRoomBookingActive ? "text-zinc-800 float-left text-base font-normal font-Inter" : " text-stone-500"
            }`}
          >
            Room Booking
          </span>
        ...
        >
          ...
          <span
            className={`text-xl pt-2 flex md:flex ${
              isMyBookingActive ? "text-zinc-800 float-left text-base font-normal font-Inter" : " text-stone-500"
            }`}
          >
            My Booking
          </span>
        ...
        >
          ...
          <span
            className={`text-xl pt-2 flex md:flex ${
              isProfileActive ? "text-zinc-800 float-left text-base font-normal font-Inter" : " text-stone-500"
            }`}
          >
            Profile
          </span>
