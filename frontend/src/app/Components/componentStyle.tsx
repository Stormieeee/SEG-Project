export const inputFormat = `bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5 sm:text-sm 
focus:outline-none focus:shadow-inner focus:shadow-black-50 focus:placeholder-transparent 
dark:bg-gray-700 dark:border-gray-600 dark:text-slate-200 dark:focus:shadow-slate-800 `;
